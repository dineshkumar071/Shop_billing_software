...
def AddNewWindow():
    ...
    lbl_quantity = Label(Form, text="Weight", font=('arial', 14), bd=5)
...
var = StringVar()
var.set("Date:" )
label = Label(Top,justify="left",font=('arial', 12), width=500,textvariable=var, relief=RAISED )
label.pack(fill=X)
...
tree.heading('Quantity', text="Weight", anchor=W)
